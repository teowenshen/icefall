...
from asr_datamodule import LaboroTVAsrDataModule
...
from telegramlogging import TelegramStreamIO
...
def get_parser():
    ...
    parser.add_argument(
        "--bpe-model",
        type=str,
        default="data/lang_bpe/bpe.model",
...
def run(rank, world_size, args):
    ...
    # lexicon = Lexicon(params.lang_dir)
    # max_token_id = len(lexicon.tokens)
    # num_classes = max_token_id + 1  # +1 for the blank
    ...
    aishell = LaboroTVAsrDataModule(args)
    ...
    logging.warning("Train_cuts gotten")
...
def main():
    parser = get_parser()
    LaboroTVAsrDataModule.add_arguments(parser)
